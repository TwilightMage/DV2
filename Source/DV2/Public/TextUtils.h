...
#define FORMAT_LOCTEXT(Namespace, Pattern, ...) FText::Format(LOCTEXT(Pattern, Pattern), __VA_ARGS__)
...
#define MAKE_LOCTEXT(Text) FInternationalization::ForUseOnlyByLocMacroAndGraphNodeTextLiterals_CreateText(TEXT(Text), TEXT(LOCTEXT_NAMESPACE), TEXT(Text))
